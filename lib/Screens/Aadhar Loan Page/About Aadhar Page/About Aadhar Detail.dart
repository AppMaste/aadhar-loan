...
class AboutAadharDetailScreen extends StatelessWidget {
  AboutAadharDetailScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        backController.backbuttonWidget(context, "/AboutAadharDetailScreen");
        return Future(() => false);
      },
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Stack(
            children: [
              ...
              banner.getBN("/AboutAadharDetailScreen")
            ],
          ),
        ),
      ),
