...
class BalanceOnlineScreen extends StatelessWidget {
  const BalanceOnlineScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        backController.backbuttonWidget(context, "/BalanceOnlineScreen");
        return Future(() => false);
      },
      child: Scaffold(
                ...
                child: Column(
                  children: [
                    ...
                    applyContainerWidget(context, "Copy Link", () {
                      ...
                      Clipboard.setData(
                          const ClipboardData(text: "7738299899"));
                    })
                  ],
                ),
              ),
              banner.getBN("/BalanceOnlineScreen")
            ],
          ),
        ),
      ),
