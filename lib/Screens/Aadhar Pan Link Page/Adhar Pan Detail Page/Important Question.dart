...
import 'Important Question Detail.dart';

class ImportantQuestionScreen extends StatelessWidget {
  ImportantQuestionScreen({super.key});
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      tapController.buttonWidget(context, "/ImportantQuestionDetailScreen", importantdetail[index]);
