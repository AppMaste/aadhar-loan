...
class Form3Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        backController.backbuttonWidget(context, "/Form3Screen");
        return Future(() => false);
      },
      child: Scaffold(
              ...
              SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: ScreenMQ.fSize_20()),
                    textFieldWidget(context, "Enter Date of Birth",
                        dobController, TextInputType.datetime, 10),
                    SizedBox(height: ScreenMQ.fSize_20()),
                    Text(
                      "Select Gender:",
